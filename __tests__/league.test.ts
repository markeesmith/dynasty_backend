...
test('Fetches all league IDs', async () => {
  const leagueIds = await league.getAllLeagueIds(league.getLeagueId());
  expect(leagueIds.sort()).toEqual(['649984475912036352', '515530667727593472', '376381169673076736'].sort());
});
